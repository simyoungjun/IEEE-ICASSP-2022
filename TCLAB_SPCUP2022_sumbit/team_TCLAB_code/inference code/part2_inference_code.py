...
eval_volume_path = 'C:/Users/GJ/PycharmProjects/2022SPCUP/spcup_2022_eval_part2'
...
train_sc = np.load("./part2_train_sc_robust.npy")
...
thresholds = [1e-9 , 1e-9 ,1e-9, 1e-9 ,7e-6]
...
df = pd.DataFrame(dic)
new_csv_file = df.to_csv(r'answer_part2.csv', index=False)